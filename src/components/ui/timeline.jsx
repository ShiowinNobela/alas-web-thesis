  ...
  return (
    ...
    >
      <div
        data-slot="timeline"
        className={cn(
          'group/timeline flex py-8 data-[orientation=horizontal]:w-full data-[orientation=horizontal]:flex-row data-[orientation=vertical]:flex-col',
          className
        )}
...
function TimelineDate({ asChild = false, className, ...props }) {
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-muted-foreground block pr-16 text-xs font-medium group-data-[orientation=vertical]/timeline:max-sm:h-4',
        className
      )}
      {...props}
    />
