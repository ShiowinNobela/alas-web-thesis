function ThankYouPopUp({open, onClose, children}) {
  return (
    <div onClick={onClose} className={open? " fixed flex items-center justify-center inset-0 transition-colors bg-black/20 " : "hidden"}  >
        <div onClick={e => e.stopPropagation()} className={open? "bg-white rounded-xl shadow p-6 transition-all scale-100 opacity-100" : "scale-125 opacity-0"} >
