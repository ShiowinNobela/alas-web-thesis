...
function ProductManagement() {
  ...
  return (
    ...
    <Sidebar/>
      <div className='min-h-full w-screen ml-[256px] flex'>
        <div className='flex flex-row'>
          <Link to='/Admin/AddProduct'>
          <button className=' fixed top-10 right-0 mr-15 mt-5 p-5 text-xl font-semibold bg-[#28762c] text-white rounded-3xl border-2 border-black '>Add Product</button>
          </Link>
        </div>
        <div className='2xl:w-6xl w-3xl grid 2xl:grid-cols-4 grid-cols-2 mt-10  2xl:gap-x-10 gap-x-2 '>
