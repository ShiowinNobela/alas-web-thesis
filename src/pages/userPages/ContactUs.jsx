      ...
      <main className="relative max-w-5xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
        ...
        <motion.div className="grid grid-cols-1 gap-16 lg:grid-cols-2 xl:gap-20" variants={containerVariants}>
          ...
          <motion.div variants={itemVariants} whileHover="hover">
            <motion.div variants={cardHoverVariants}>
              <Card className="py-0 transition-all duration-300 border shadow-xl bg-card/80 backdrop-blur-sm hover:shadow-2xl">
                <CardHeader className="py-2 text-white rounded-t-lg bg-gradient-to-r from-red-500 to-orange-500">
          ...
          <motion.div className="space-y-6" variants={itemVariants}>
            <motion.div variants={itemVariants} whileHover="hover">
              <motion.div variants={cardHoverVariants}>
                <Card className="transition-all duration-300 border-0 shadow-xl testimonial-gradient hover:shadow-2xl">
                  <CardHeader>
                    <CardTitle className="flex items-center text-xl text-content">
                      <motion.div
                        animate={{
                          x: [-2, 2, -2],
            ...
            >
              ...
              <p className="mt-2 text-xs italic text-lighter dark:text-neutral">Pro tip: Keep milk handy for your first taste test! 🥛</p>
            </motion.div>
          </motion.div>
        </motion.div>
      </main>
