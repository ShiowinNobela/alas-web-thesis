        ...
        <Card className="text-card from-primary to-brand bg-gradient-to-r">
          <CardContent className="p-6 text-center lg:p-12">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-center sm:gap-4">
              ...
              <Button
                variant="outline"
                className="border-card hover:bg-card font-heading text-card rounded-full border-2 px-6 py-3 text-sm font-semibold transition-all sm:px-8 sm:py-6 sm:text-base"
              >
                Our Story
              </Button>
            </div>
