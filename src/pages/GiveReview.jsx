  ...
  return (
    <>
      <section className="max-h-screen h-screen w-full bg-yellow-100 bg-cover bg-no-repeat flex items-center justify-center">
        <div className="md:mt-0 mt-20 flex flex-col justify-center items-center bg-[#FFD700] md:h-[500px] h-[700px] md:w-[800px] w-[360px] rounded-md shadow-lg shadow-black/50 border-black border-2">
