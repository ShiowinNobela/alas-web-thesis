...
function Faqs() {
  ...
  const updateShow = (index) => { 
    setShow((prevShow) => prevShow.map((item, i) => (i === index ? !item : item)));
  }
  console.log(show)
  ...
  return (
    ...
    <div className="max-w-xl mx-auto pt-35">    
        ...
        {questions.map((question, index) => (
            ...
            <div key={index} className='border-2 border-gray-500 rounded-lg bg-white shadow-md'>
                ...
                <article className={`${show[index] && "border-t-2 border-gray-500 mt-2 p-4"}`}>
