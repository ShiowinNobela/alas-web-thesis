...
const LandingPage = () => {
  ...
  return (
    <>
      <section className="relative bg-[url('./src/components/images/BGYuwe.jpg')] bg-cover bg-center min-h-screen flex flex-col justify-center items-start px-10 py-16 text-left overflow-x-hidden">
      ...
      <section className="bg-[url('./src/components/images/BGS.jpg')] h-screen bg-cover bg-center py-24 px-6 sm:px-10 text-center flex flex-col justify-center">
        <h2 className="text-6xl font-extrabold text-black drop-shadow mb-16">
