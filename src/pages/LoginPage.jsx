...
function LoginPage() {
  ...
  return (
    <>
      <section className="h-screen flex items-center justify-center bg-[url('./src/components/images/bg-1.jpg')] bg-center bg-no-repeat">
        
        <div className="flex h-[700px] w-[400px] flex-col items-center justify-center text-center   rounded-2xl max-md:hidden">
