  ...
  <div className='flex h-[700px] w-[400px] flex-col items-center justify-center text-center p-10  rounded-2xl max-md:hidden' >
    ...
    <div className='flex text-white'>
      <div className='flex flex-col items-center justify-center text-center p-5 gap-7  rounded-2xl'>
        <h1 className='text-2xl font-bold'>Welcome To  <h1 className='text-[#EA1A20]'>Alas Delis and Spices</h1></h1>
        ...
        <Link to="/RegPage">
        <p className='text-sm'>New to the Website? <a href="#" className='border-b cursor-pointer'> Create an Account now!</a></p>
        </Link>
      </div>
    </div>
  </section>
