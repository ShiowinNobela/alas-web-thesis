...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden">
      <div
        className="flex min-h-[400px] sm:min-h-[500px] w-full items-center justify-center bg-cover bg-center bg-no-repeat md:min-h-[500px]"
        style={{
      ...
      >
        ...
        <div className="container relative z-10 px-4 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="mb-6 text-2xl font-bold text-white font-heading drop-shadow-lg sm:text-4xl md:text-5xl lg:text-7xl">
              Artisanal Hot Sauce and Some Spicy Stuff
            </h1>

            <p className="mb-6 text-sm text-white sm:mb-8 sm:text-lg opacity-90">
            ...
            <div className="flex flex-col justify-center gap-4 px-4 sm:px-8 sm:flex-row">
        ...
        <div className="absolute -translate-x-1/2 bottom-8 left-1/2"></div>
      </div>
    </section>
  );
};
