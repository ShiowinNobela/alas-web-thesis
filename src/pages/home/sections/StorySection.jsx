        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          <div className="relative h-full min-h-[300px] sm:min-h-[400px]">
            <motion.div
              ...
              className="relative h-full overflow-hidden rounded-lg shadow-2xl sm:rounded-xl"
            >
              <img
            ...
            <motion.div
              ...
              className="border-primary absolute -right-3 bottom-0 z-10 w-40 overflow-hidden rounded-xl border-4 bg-white shadow-[0_10px_20px_rgba(0,0,0,0.3)] sm:-right-10 md:-right-12 md:bottom-2 md:w-48 lg:-right-14 lg:bottom-4 lg:w-56"
            >
              <img
