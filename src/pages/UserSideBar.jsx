...
function UserSideBar({setActiveSwitch}) { //NEW USER SIDEBAR
  ...
  useEffect(() => {
    ...
    <aside id="separator-sidebar" className="fixed top-20 left-0 z-40 w-64 h-[calc(100vh-5rem)] transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          ...
          <ul class="space-y-2 font-medium">
            ...
            <li onClick={() => { 
                ...
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Order List</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg class="h-8 w-8 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                      <RiArchiveStackLine />
                  </svg>
