          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div className="mb-8 text-center">
              <div className="flex items-center justify-center mb-6">
                <div className="w-20 h-20 p-4 bg-gray-200 rounded-full animate-pulse"></div>
              </div>
              <div className="w-1/3 h-10 mx-auto mb-2 bg-gray-200 rounded animate-pulse"></div>
              <div className="w-1/4 h-6 mx-auto bg-gray-200 rounded animate-pulse"></div>
            </div>

            {/* Stats Cards Skeleton */}
            <div className="grid grid-cols-1 gap-4 mb-8 sm:grid-cols-2 lg:grid-cols-4">
              {[...Array(4)].map((_, idx) => (
                <CardSkeleton key={idx} className="h-32" />
              ))}
            </div>

            {/* Controls Skeleton */}
            <div className="p-6 mb-8 bg-white rounded-lg shadow-lg animate-pulse">
            ...
            <div className="space-y-4">
              {[...Array(3)].map((_, idx) => (
                <div key={idx} className="p-6 bg-white rounded-lg shadow-lg animate-pulse">
              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                  ...
                  <select
                    ...
                    className="py-2 pr-6 text-gray-900 bg-white border border-gray-300 rounded-lg focus:border-red-500 focus:ring-2 focus:ring-red-200 focus:outline-none"
                  >
