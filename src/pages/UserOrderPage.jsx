...
function UserViewOrderPage() {
  ...
  return (
    <>
      <section className="bg-yellow-100 bg-cover bg-fixed bg-no-repeat max-w-screen max-h-full h-screen pt-5 ">
        <div className="max-w-6xl mx-auto px-3 py-3 border-black border-3 mt-[80px] bg-gray-100 rounded-md">
          <h1 className="py-5 text-2xl font-semibold text-center">Orders</h1>
          <div className="flex items-center justify-center">
            <table className="border-1 border-black w-5xl text-center bg-white">
              <tr>
